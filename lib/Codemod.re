...
let mapper =
  ...
  let items =
    ...
    |> List.map(item => {
         ...
         | {
             pexp_desc:
               Pexp_apply(
                 ...
                 [(Nolabel, {pexp_desc: Pexp_construct(_, Some(value))})],
               ),
           }
         | {
             pexp_desc:
               Pexp_apply(
                 {
                   pexp_desc: Pexp_ident({txt: Lident("color" as propName)}),
                 },
                 [(Nolabel, {pexp_desc: Pexp_construct(_, Some(value))})],
               ),
           } => (
               ...
               Pexp_apply(
                 ...
                 [
                   (
                     Nolabel,
                     {
                       pexp_desc: Pexp_construct({txt: Lident("Center")}, _),
                     },
                   ),
                 ],
               ),
         ...
         | {
               ...
               Pexp_apply(
                 ...
                 [
                   (
                     ...
                     {
                       pexp_desc:
                         Pexp_construct({txt: Lident("SpaceAround")}, _),
                     },
                   ),
                 ],
               ),
             ...
             Labelled(name),
             Exp.ident({txt: Lident("`spaceAround"), loc: Location.none}),
           )
         | {
             pexp_desc:
               Pexp_apply(
                 ...
                 [
                   (
                     ...
                     {
                       pexp_desc:
                         Pexp_construct({txt: Lident("SpaceBetween")}, _),
                     },
                   ),
                 ],
               ),
               ...
               Pexp_apply(
                 ...
                 [
                   (
                     Nolabel,
                     {
                       pexp_desc: Pexp_construct({txt: Lident("Column")}, _),
                     },
                   ),
                 ],
               ),
  ...
  {...structure, pexp_desc: Pexp_apply(expression, items)};
};
